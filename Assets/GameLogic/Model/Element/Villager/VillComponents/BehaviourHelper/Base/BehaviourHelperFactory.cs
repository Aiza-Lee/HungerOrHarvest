...
namespace GameLogic.Model.Element.Vill {
	...
	/// </summary>
	public sealed class BehaviourHelperFactory {
		private BehaviourHelperFactory() { }
		public static BehaviourHelperFactory Inst { get; } = new();
		public static IBehaviourHelper CreateBehaviourHelper(LogicImpler impler) {
			var builder = new BehaviourTreeBuilder<MyBlackboard>();
			var tree = builder
				.Blackboard(new MyBlackboard(impler))
				.Selector()
			...
			return new BehaviourHelper(tree);
		}
