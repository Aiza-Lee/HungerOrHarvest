...
using GameLogic.Common.ViewsMono.SmoothChange;
using UnityEngine;

namespace GameLogic.Common.ViewsMono.AlphaController {
	public class AlphaController : MonoBehaviour {
		...
		private void Update() {
			...
			if (transform.position.z > cmrZ && (transform.position.z - cmrZ) <= ConstMgr.LayerGap) {
				_updating = true;
				var gap = ConstMgr.LayerGap;
