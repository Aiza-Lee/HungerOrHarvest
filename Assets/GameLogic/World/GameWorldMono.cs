	...
	public class GameWorldMono : WorldBehaviour {
		...
		protected override void RegisterSystems() {
			World.SystemManager
				...
				.RegisterSystem<ArchGeneratorInfoConsumeSystem>()
				.RegisterSystem<ArchGeneratorSystem>()
				.RegisterSystem<LayerGeneratorInfoConsumeSystem>()
				.RegisterSystem<LayerGeneratorSystem>()
				.RegisterSystem<VillGeneratorInfoConsumeSystem>()
		...
		protected override void RegisterResources() {
			World
				...
				.InsertResource(new MainCameraResource())
